...
1. If the folder ./audio exists the ArchiMob audio files are pre-processed:
  <p>1.1 First, files are merged from subfolders into ./Pre_Processing_Files/audio_merged.</p>
  <p>1.2 Next, the .wav files are pre-processed according to above format-specifications</p>
